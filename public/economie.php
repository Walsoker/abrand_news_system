...
<head>
    ...
    <title>Économie | Abrand News</title>
...
<body>
    ...
    <header>
        <nav class="user-nav">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="text-right border-l pl-6 border-gray-200">
                    ...
                    <p class="text-[9px] text-blue-500 font-bold uppercase">Économie</p>
                </div>
        ...
        <nav class="main-menu hidden md:flex">
            ...
            <a href="economie.html" class="text-[10px] font-black uppercase tracking-widest text-blue-600 border-b-2 border-blue-600">Économie</a>
            ...
            <a href="geopolitique.html" class="text-[10px] font-black uppercase tracking-widest hover:text-blue-600">Géopolitique</a>
        </nav>
    </header>
    ...
    <main class="container mx-auto px-6 py-12">
        ...
        <div class="section-header">
            <h1 class="serif text-5xl font-black uppercase tracking-tighter">Économie</h1>
            <p class="text-xs font-bold opacity-50 uppercase tracking-widest mt-2">Marchés, Finance Verte et Modèles Circulaires</p>
        </div>
        ...
        <div class="layout-grid">
            ...
            <div class="card-featured reveal">
                ...
                <img src="https://images.unsplash.com/photo-1611974717528-587ec93ff01a?auto=format&fit=crop&q=80&w=1200" class="bg-img">
                <div class="overlay"></div>
                <div class="content">
                    <span class="tag" style="color: white; border-bottom: 1px solid white; display: inline-block;">Macro-économie</span>
                    <h2 class="title-featured">Le PIB à l'épreuve de la régénération.</h2>
                    <p class="text-sm opacity-90 leading-relaxed mb-4">Pourquoi la croissance brute ne suffit plus à mesurer la santé réelle des nations en 2026.</p>
                    <div class="read-more" style="color: white;">Lire le dossier <i class="fas fa-arrow-right"></i></div>
                </div>
            </div>

            <div class="card-standard reveal">
                <div class="img-box">
                    <div class="aleph-badge">ALEPH 97%</div>
                    <img src="https://images.unsplash.com/photo-1559526324-4b87b5e36e44?auto=format&fit=crop&q=80&w=800" class="article-img">
                </div>
                <div>
                    <span class="tag">Finance</span>
                    <h3 class="title-standard">Banques : L'obligation de reporting carbone direct.</h3>
                    <p class="text-sm opacity-70 serif">Toutes les transactions devront bientôt afficher leur équivalent CO2 sur les relevés clients.</p>
            ...
            <div class="card-standard reveal">
                <div class="img-box">
                    ...
                    <img src="https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?auto=format&fit=crop&q=80&w=800" class="article-img">
                </div>
                <div>
                    <span class="tag">Investissement</span>
                    <h3 class="title-standard">Les fonds ESG surperforment le Nasdaq.</h3>
                    <p class="text-sm opacity-70 serif">L'analyse des rendements du premier semestre montre une résilience inédite des actifs certifiés durables.</p>
            ...
            <div class="card-standard reveal">
                <div class="img-box">
                    ...
                    <img src="https://images.unsplash.com/photo-1554469384-e58fac16e23a?auto=format&fit=crop&q=80&w=800" class="article-img">
                </div>
                <div>
                    <span class="tag">Immobilier</span>
                    <h3 class="title-standard">Conversion : Le nouveau business des parkings vides.</h3>
                    <p class="text-sm opacity-70 serif">Comment les foncières transforment les sous-sols urbains en fermes de données ou en hubs logistiques.</p>
                    <span class="read-more">Lire la suite <i class="fas fa-chevron-right text-[8px]"></i></span>
                </div>
            </div>
            ...
            <div class="card-standard reveal">
                <div class="img-box">
                    ...
                    <img src="https://images.unsplash.com/photo-1473186578172-c141e6798ee4?auto=format&fit=crop&q=80&w=800" class="article-img">
                </div>
                <div>
                    <span class="tag">Commerce</span>
                    <h3 class="title-standard">Seconde main : Un marché à 100 milliards d'euros.</h3>
                    <p class="text-sm opacity-70 serif">Le luxe et l'électronique tirent la croissance d'un secteur qui ne connaît pas la crise.</p>
                    <span class="read-more">Lire la suite <i class="fas fa-chevron-right text-[8px]"></i></span>
                </div>
            </div>
            ...
            <div class="card-standard reveal">
                <div class="img-box">
                    ...
                    <img src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=800" class="article-img">
                </div>
                <div>
                    <span class="tag">Emploi</span>
                    <h3 class="title-standard">Salaires : La prime à la compétence verte.</h3>
                    <p class="text-sm opacity-70 serif">Les ingénieurs spécialisés en efficacité énergétique voient leurs rémunérations bondir de 25%.</p>
                    <span class="read-more">Lire la suite <i class="fas fa-chevron-right text-[8px]"></i></span>
                </div>
            </div>
        ...
        <button class="btn-load-more reveal">Voir plus d'articles Économie</button>
